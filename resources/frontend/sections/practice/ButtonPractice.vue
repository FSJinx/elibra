...
<template>
  <div class="flex flex-col w-full">
    <h1 class="text-2xl text-center font-bold p-5 bg-gray-500 text-white w-full">Buttons</h1>
    <table class="table-fixed">
      <thead>
        <tr>
          <th>Name</th>
          <th>Component Sample</th>
        </tr>
      </thead>
      <tbody>
        <!-- Solid Small Buttons -->
