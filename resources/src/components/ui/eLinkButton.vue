<template>
  <router-link :to="to" :class="[size, radi[radius], variants[variant][color]]" class="text-shadow inline-flex shrink-0 items-center justify-center gap-1 border text-center leading-none px-3 cursor-pointer transition-all duration-200">
