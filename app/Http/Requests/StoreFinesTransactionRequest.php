...
class StoreFinesTransactionRequest extends BaseRequest
{
    /**
    ...
    public function rules(): array
    {
        return [
            ...
            'transaction_type' => ['required', Rule::in(['charged', 'paid', 'waived'])],
            'remarks' => ['nullable', 'string'],
            'patron_id' => ['required', 'integer', Rule::exists((new Patron)->getTable(), 'id')],
            'circulation_id' => ['required', 'integer', Rule::exists((new Circulation)->getTable(), 'id')],
            'processed_by' => ['required', 'integer', Rule::exists((new User)->getTable(), 'id')],
        ];
    }
