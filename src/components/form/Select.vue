<template>
  <div ref="dropdownRef" class="relative inline-flex items-center min-w-40 w-full">
    ...
    <Transition name="dropdown">
      <div role="listbox" :class="[open ? 'grid' : 'hidden']" class="options grid gap-0.5 absolute w-full min-w-75 bg-background rounded-md shadow border border-border mt-2 p-2 top-full left-0 right-0 z-50 max-h-100 overflow-y-auto scrollbar-thin">
