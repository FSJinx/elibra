<template>
  <div class="relative inline-flex items-center w-full border border-slate-300 overflow-hidden transition-all duration-200 focus-within:shadow-green-200 focus-within:shadow-[0_0_0_0.20rem]">
    ...
    <Button icon="x-lg"></Button>
    <button class="absolute right-1 p-2 cursor-pointer shrink-0 hover:bg-slate-100 transition-all duration-150" @click="clear" v-if="model.length > 0">
      <Eicon icon="X"></Eicon>
    </button>
  </div>
</template>
