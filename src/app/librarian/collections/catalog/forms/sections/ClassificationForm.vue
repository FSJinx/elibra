  ...
  <section class="overflow-hidden border border-border bg-background rounded-lg">
    ...
    <div class="divide-y divide-border">
      <Control class="control" v-if="auth.user?.role === 'admin'">
        ...
        <Select id="book-branch_id" class="capitalize" v-model="form.branch_id" required :error="errors.branch_id">
      ...
      <Control class="control">
        ...
        <Select id="book-item_type_category_id" class="capitalize" v-model="form.item_type_category_id" required :error="errors.item_type_category_id">
      ...
      <Control class="control">
        ...
        <Select id="book-language" class="capitalize" v-model="form.language_id" :error="errors.language_id">
...
watch(branchOptions, () => console.log(branchOptions.value, branches), { deep: true, immediate: true })
</script>
