  ...
  <div class="size-full flex flex-col gap-5 w-full max-w-7xl mx-auto">
    <div class="flex items-start justify-end gap-2">
      <div class="space-y-1 mr-auto">
        <Title :level="1" class="sm:text-3xl">{{ campus.currentData?.name }} ({{ campus.currentData?.code }})</Title>
      </div>
    ...
    <div class="flex-1 flex flex-col gap-5">
      <Card class="grid grid-cols-2 gap-5">
        <h1 class="uppercase text-muted-foreground font-medium col-span-2">Campus Information</h1>
        <div>
        ...
        <div>
          ...
          <p class="card-data">{{ campus.currentData?.status }}</p>
        </div>
        <div>
      ...
      <div class="grid grid-cols-2 gap-5">
        <Card class="flex items-center gap-5">
          <span class="flex border border-success/15 rounded-xl text-success bg-success-soft size-15"><Icon class="m-auto text-xl" icon="calendar" /></span>
        ...
        <Card class="flex items-center gap-5">
          <span class="flex border border-restore/15 rounded-xl text-restore bg-restore-soft size-15"><Icon class="m-auto text-xl" icon="calendar" /></span>
          <div class="space-y-1.5">
